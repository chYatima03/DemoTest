                    ...
                    <div className="lg:col-span-3 lg:col-start-10">
                        <div className="flex gap-2 lg:justify-end">
                            <button type="button" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20" onClick={toggle}>
                                <Plus className="inline-block w-4 h-4" /> <span className="align-middle">Add User</span>
                            </button>
                            <button type='button' className="flex items-center justify-center w-[37.5px] h-[37.5px] p-0 text-white btn bg-slate-500 border-slate-500 hover:text-white hover:bg-slate-600 hover:border-slate-600 focus:text-white focus:bg-slate-600 focus:border-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:border-slate-600 active:ring active:ring-slate-100 dark:ring-slate-400/10"><SlidersHorizontal className="w-4 h-4" /></button>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <div className="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                {(data || []).map((item: any, key: number) => (<div className="card" key={key}>
                    <div className="card-body">
                        <div className="relative flex items-center justify-center w-16 h-16 mx-auto text-lg rounded-full bg-slate-100 dark:bg-zink-600">
                            {item.img ? <img src={item.img} alt="" className="w-16 h-16 rounded-full" /> : (item.name.split(' ').map((word: any) => word.charAt(0)).join(''))}
                            {item.isActive ? <span className="absolute w-3 h-3 bg-green-400 border-2 border-white rounded-full dark:border-zink-700 bottom-1 ltr:right-1 rtl:left-1"></span> :
                                <span className="absolute w-3 h-3 bg-red-400 border-2 border-white rounded-full dark:border-zink-500 bottom-1 right-1"></span>}
                        </div>
                        ...
                        <div className="flex gap-2 mt-5">
                            <Link to="/apps-chat" className="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:bg-zink-700 dark:hover:bg-custom-500 dark:ring-custom-400/20 dark:focus:bg-custom-500 grow"><MessagesSquare className="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">Send Message</span></Link>
                            <Dropdown className="relative">
                                <Dropdown.Trigger type="button" id="userGridDropdown12" className="flex items-center justify-center w-[37.5px] h-[37.5px] p-0 text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                                ...
                                <Dropdown.Content placement="right-end" className="absolute z-50 py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md min-w-[10rem] dark:bg-zink-600" aria-labelledby="userGridDropdown12">
                                    ...
                                    <li>
                                        <Link className="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200" to="#!" onClick={() => onClickDelete(item)}><Trash2 className="inline-block w-3 h-3 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">Delete</span></Link>
                                    </li>
                                </Dropdown.Content>
                            </Dropdown>
                        </div>
