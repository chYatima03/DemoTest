...
// console.log('1');
        ...
        },
        {
            ...
            cell: (cell: any) => (
                <div className="flex justify-end gap-2">
                    {cell.row.original.status === "Pending" && <Link to="#!" className="flex items-center justify-center w-8 h-8 transition-all duration-200 ease-linear rounded-md text-slate-500 bg-slate-100 hover:text-white hover:bg-slate-500 dark:text-zink-200 dark:bg-zink-600 dark:hover:text-white dark:hover:bg-zink-400"><Pencil className="w-4 h-4" /></Link>}
    ...
    return (
        <React.Fragment>
            <BreadCrumb title='Storage Manage' pageTitle='Storage Manage' />
            ...
            <div className="card" id="ordersTable">
                <div className="card-body">
                    <div className="grid grid-cols-1 gap-4 mb-5 lg:grid-cols-2 xl:grid-cols-12">
                        ...
                        <div className="xl:col-span-2 xl:col-start-10">
                            <div className="ltr:lg:text-right rtl:lg:text-left ">
                                <Link to="/apps-wms-create-plan" type="button" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><Plus className="inline-block w-4 h-4" /> <span className="align-middle">Add Location Storage</span></Link>
                            </div>
                        </div>
                        <div className="xl:col-span-1 xl:col-start-12">
                            <div className="ltr:lg:text-right rtl:lg:text-left">
                                <Link to="/apps-wms-create-storage-location" type="button" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><Plus className="inline-block w-4 h-4" /> <span className="align-middle">Add Storage</span></Link>
                            </div>
                        </div>
                    </div>
