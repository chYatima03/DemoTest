...
// console.log('1');
    const selectDataList = createSelector(
        (state: any) => state.DOCManagment,
        (state) => ({
            dataList: state.documentlist
        })
    );
    ...
    const filterSearchData = (e: any) => {
        ...
        const keysToSearch = ['docno', 'docname', 'status'];
    ...
    return (
        <React.Fragment>
            <BreadCrumb title='Document Manage' pageTitle='Document Manage' />
