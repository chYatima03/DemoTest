...
const TransferManage = () => {
    ...
    const selectDataList = createSelector(
        (state: any) => state.WMSManagment,
        (state) => ({
            dataList: state.planlist
        })
    );
    const selectDataDetaillist = createSelector(
        (state: any) => state.WMSManagment,
        (state) => ({
            dataDetailList: state.planlist
        })
    );

    const { dataList } = useSelector(selectDataList);
    const { dataDetailList } = useSelector(selectDataDetaillist);
    ...
    const filterSearchData = (e: any) => {
        ...
        const keysToSearch = ['planno', 'planname', 'status'];
        ...
        },
        {
            ...
            cell: (cell: any) => (
                <div className="flex justify-end gap-2">
                    {cell.row.original.status === "Close" && <Link to="#!" className="flex items-center justify-center w-8 h-8 transition-all duration-200 ease-linear rounded-md text-slate-500 bg-slate-100 hover:text-white hover:bg-slate-500 dark:text-zink-200 dark:bg-zink-600 dark:hover:text-white dark:hover:bg-zink-400"><Pencil className="w-4 h-4" /></Link>}
                    <Link to="#!" data-modal-target="leaveOverviewModal" className="flex items-center justify-center w-8 h-8 transition-all duration-200 ease-linear rounded-md text-custom-500 bg-custom-100 hover:text-white hover:bg-custom-500 dark:bg-custom-500/20 dark:hover:bg-custom-500"><Info className="w-4 h-4" /></Link>
                </div>
            ),
        }
    ], []
    ...
    return (
        <React.Fragment>
            <BreadCrumb title='Transfer Manage' pageTitle='Transfer Manage' />
            ...
            {/* <div className="xl:col-span-3">
                    <div className="card">
                        <div className="flex items-center gap-3 card-body">
                            <div className="flex items-center justify-center w-12 h-12 text-red-500 bg-red-100 rounded-md text-15 dark:bg-red-500/20 shrink-0"><FileBarChart2 /></div>
                            <div className="grow">
                                <h5 className="mb-1 text-16">
                                    <CountUp end={23} className="counter-value" />
                                </h5>
                                <p className="text-slate-500 dark:text-zink-200">Total Plan Balance</p>
                            </div>
                        </div>
                    </div>
                </div> */}
            {/* <div className="xl:col-span-3">
                    <div className="card">
                        <div className="flex items-center gap-3 card-body">
                            <div className="flex items-center justify-center w-12 h-12 text-green-500 bg-green-100 rounded-md text-15 dark:bg-green-500/20 shrink-0"><CalendarDays /></div>
                            <div className="grow">
                                <h5 className="mb-1 text-16">
            ...
            {/* <div className="xl:col-span-3">
                    <div className="card">
                        <div className="flex items-center gap-3 card-body">
                            <div className="flex items-center justify-center w-12 h-12 text-purple-500 bg-purple-100 rounded-md text-15 dark:bg-purple-500/20 shrink-0"><Stethoscope /></div>
                            <div className="grow">
                                <h5 className="mb-1 text-16">
            ...
            {/* <div className="xl:col-span-3">
                    <div className="card">
                        <div className="flex items-center gap-3 card-body">
                            <div className="flex items-center justify-center w-12 h-12 rounded-md text-sky-500 bg-sky-100 text-15 dark:bg-sky-500/20 shrink-0"><Anchor /></div>
                            <div className="grow">
                                <h5 className="mb-1 text-16">
                    ...
                    <div className="grid grid-cols-1 gap-4 mb-5 lg:grid-cols-2 xl:grid-cols-12">
                        ...
                        <div className="xl:col-span-2 xl:col-start-11">
                            <div className="ltr:lg:text-right rtl:lg:text-left">
                                <Link to="/apps-wms-create-transfer" type="button" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><Plus className="inline-block w-4 h-4" /> <span className="align-middle">Add Transfer</span></Link>
                            </div>
                        </div>
                    </div>
                ...
                <div className="card-body">
                    <div className="grid grid-cols-1 gap-4 mb-5 lg:grid-cols-2 xl:grid-cols-12">
                        <div className="xl:col-span-2">
                            <div className="relative">
                                <label>Document No: RL ใบย้ายสินค้า</label>
                                {/* <label>Transfer No: 67551022</label> */}
                                {/* <label>Date No: 29/02/2567 </label> */}
                                {/* <input type="text" className="ltr:pl-8 rtl:pr-8 search form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Search for ..." autoComplete="off" onChange={(e) => filterSearchData(e)} /> */}
                                {/* <Search className="inline-block w-4 h-4 absolute ltr:left-2.5 rtl:right-2.5 top-2.5 text-slate-500 dark:text-zink-200 fill-slate-100 dark:fill-zink-600" /> */}
                            </div>
                            <div className="relative">
                        ...
                        <div className="relative">
                                {/* <label>Document No: 67551022 ใบย้ายสินค้า</label> */}
                                <label>Transfer No: 67551022</label>
                                {/* <label>Date No: 29/02/2567 </label> */}
                                {/* <input type="text" className="ltr:pl-8 rtl:pr-8 search form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Search for ..." autoComplete="off" onChange={(e) => filterSearchData(e)} /> */}
                                {/* <Search className="inline-block w-4 h-4 absolute ltr:left-2.5 rtl:right-2.5 top-2.5 text-slate-500 dark:text-zink-200 fill-slate-100 dark:fill-zink-600" /> */}
                        ...
                        <div className="xl:col-span-1 xl:col-start-12">
                            <div className="ltr:lg:text-right rtl:lg:text-left">
                                <Link to="/apps-wms-create-plan" type="button" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><Plus className="inline-block w-4 h-4" /> <span className="align-middle">Add Detail</span></Link>
                            </div>
                        </div>
                    </div>
                    <div className="overflow-x-auto">
