            ...
            <div className="order-10 col-span-12 2xl:order-1 card 2xl:col-span-4">
                <div className="card-body">
                    <div className="flex items-center gap-2 mb-3">
                        <h6 className="text-15 grow">Daily Visit Insights <Link to="#!" data-tooltip="default" data-tooltip-content="Analyst or business user discovering a pattern in data or a relationship between variables" className="inline-block align-middle ltr:ml-1 rtl:mr-1 text-slate-500 dark:text-zink-200"><Info className="w-4 h-4"></Info></Link></h6>
                        <Dropdown className="relative shrink-0">
                            ...
                            <Dropdown.Content placement="right-end" className="absolute z-50 py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600" aria-labelledby="dailyVisitInsightsDropdown">
                                <li>
                    ...
                    <DailyVisitChart chartId="dailyVisitInsightsChart" data-chart-colors='["bg-green-500", "bg-purple-500"]' />
                </div>
            </div>
        </React.Fragment>
    );
