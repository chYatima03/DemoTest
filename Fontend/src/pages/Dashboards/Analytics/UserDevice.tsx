...
const UserDevice = () => {
    return (
        <React.Fragment>
            <div className="order-8 col-span-12 lg:col-span-6 2xl:order-1 card 2xl:col-span-4">
                <div className="card-body">
                    <div className="flex items-center gap-2 mb-3">
                        <h6 className="text-15 grow">User Device <Link to="#!" data-tooltip="default" data-tooltip-content="You can see your number of desktop, mobile, and tablet users." className="inline-block align-middle ltr:ml-1 rtl:mr-1 text-slate-500 dark:text-zink-200"><Info className="w-4 h-4"></Info></Link></h6>
                    ...
                    <UserDeviceChart chartId="userDeviceCharts" />
                </div>
            </div>
        </React.Fragment>
    );
