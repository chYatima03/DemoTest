                ...
                <div className="card-body">
                    ...
                    <ul className="flex flex-col gap-5">
                        <li className="flex items-center gap-3">
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block w-4 h-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 798</h6>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block w-4 h-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 695</h6>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block w-4 h-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 985</h6>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block w-4 h-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 813</h6>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block w-4 h-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 915</h6>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                <img src={img03} alt="" className="h-6" />
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block w-4 h-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 785</h6>
                        </li>
                    </ul>
                </div>
            </div>
