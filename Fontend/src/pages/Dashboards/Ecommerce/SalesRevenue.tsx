                ...
                <div className="card-body">
                    <div className="flex flex-col gap-4 mb-4 md:mb-3 md:items-center md:flex-row">
                        ...
                        <div className="relative">
                            <CalendarRange className="absolute w-4 h-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></CalendarRange>
                            <Flatpickr
                    ...
                    <div className="grid grid-cols-12 gap-4 mb-3">
                        <div className="col-span-12 md:col-span-6 lg:col-span-3">
                            <div className="flex items-center gap-3">
                                <div className="flex items-center justify-center w-12 h-12 rounded-md text-sky-500 bg-sky-50 shrink-0 dark:bg-sky-500/10">
                                    <BarChart />
                                </div>
                                <div className="grow">
                        ...
                        <div className="col-span-12 md:col-span-6 lg:col-span-3">
                            <div className="flex items-center gap-3">
                                <div className="flex items-center justify-center w-12 h-12 text-green-500 rounded-md bg-green-50 shrink-0 dark:bg-green-500/10">
                                    <TrendingUp />
                                </div>
                                <div className="grow">
