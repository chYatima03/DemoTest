                            ...
                            <Tab.Container defaultActiveKey="emailLogin">
                                    ...
                                    <Nav className="flex flex-wrap w-full gap-2 text-sm font-medium text-center nav-tabs">
                                        <Nav.Item eventKey="emailLogin" className="group grow">
                                            <a href="#!" data-tab-toggle data-target="emailLogin" className="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 bg-slate-100 dark:text-zink-200 dark:bg-zink-600 border border-transparent group-[.active]:bg-custom-500 dark:group-[.active]:bg-custom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]">
                                                <Mail className="inline-block w-4 h-4 mr-1"></Mail> <span className="align-middle">Email</span></a>
                                        </Nav.Item>
                                        <Nav.Item eventKey="phoneLogin" className="group grow">
                                            <a href="#!" data-tab-toggle data-target="phoneLogin" className="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 bg-slate-100 dark:text-zink-200 dark:bg-zink-600 border border-transparent group-[.active]:bg-custom-500 dark:group-[.active]:bg-custom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]">
                                                <Smartphone className="inline-block w-4 h-4 mr-1"></Smartphone> <span className="align-middle">Phone</span></a>
                                        </Nav.Item>
                                    </Nav>
                                </div>
                                <div className="lg:w-[25rem] mx-auto">
                                    <Tab.Content className="mt-5 tab-content">
                                        ...
                                        <Tab.Pane eventKey="phoneLogin" className="tab-pane" id="phoneLogin">
                                            <form action="/" className="mt-10" id="signInForm2">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        <input id="phoneCheckRememberMe" className="w-4 h-4 border rounded-sm appearance-none bg-slate-100 border-slate-200 dark:bg-zink-600 dark:border-zink-500 checked:bg-custom-500 checked:border-custom-500 dark:checked:bg-custom-500 dark:checked:border-custom-500 checked:disabled:bg-custom-400 checked:disabled:border-custom-400" type="checkbox" value="" />
                                    ...
                                    <div className="flex flex-wrap justify-center gap-2">
                                        <button type="button" className="flex items-center justify-center w-[37.5px] h-[37.5px] transition-all duration-200 ease-linear p-0 text-custom-500 btn bg-custom-100 border-custom-100 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 active:text-white active:bg-custom-600 active:border-custom-600">
                                            <Facebook className="w-4 h-4"></Facebook>
                                        </button>
                                        <button type="button" className="flex items-center justify-center w-[37.5px] h-[37.5px] transition-all duration-200 ease-linear p-0 text-orange-500 btn bg-orange-100 border-orange-100 hover:text-white hover:bg-orange-600 hover:border-orange-600 focus:text-white focus:bg-orange-600 focus:border-orange-600 active:text-white active:bg-orange-600 active:border-orange-600">
                                            <Mail className="w-4 h-4"></Mail>
                                        </button>
                                        <button type="button" className="flex items-center justify-center w-[37.5px] h-[37.5px] transition-all duration-200 ease-linear p-0 text-sky-500 btn bg-sky-100 border-sky-100 hover:text-white hover:bg-sky-600 hover:border-sky-600 focus:text-white focus:bg-sky-600 focus:border-sky-600 active:text-white active:bg-sky-600 active:border-sky-600">
                                            <Twitter className="w-4 h-4"></Twitter>
                                        </button>
                                        <button type="button" className="flex items-center justify-center w-[37.5px] h-[37.5px] transition-all duration-200 ease-linear p-0 text-slate-500 btn bg-slate-200 border-slate-200 hover:text-white hover:bg-slate-600 hover:border-slate-600 focus:text-white focus:bg-slate-600 focus:border-slate-600 active:text-white active:bg-slate-600 active:border-slate-600">
