...
//wms
import AddLocations from "pages/WMSManagement/Locations/AddLocations";
import LocationManage from "pages/WMSManagement/Locations/LocationManage";
import AddPlan from "pages/WMSManagement/Locations/AddPlan";
import AddPallet from "pages/WMSManagement/Locations/AddPallet";
import PalletManage from "pages/WMSManagement/Locations/PalletManage";
import PlanManage from "pages/WMSManagement/Locations/PlanManage";
import AddStocks from "pages/WMSManagement/Stocks/AddStocks";
import StocksManage from "pages/WMSManagement/Stocks/StocksManage";
import StorageLocationManage from "pages/WMSManagement/Locations/StorageLocationManage";
import AddStorageLocation from "pages/WMSManagement/Locations/AddStorageLocation";
import AddTransfer from "pages/WMSManagement/Transfer/AddTransfer";
import TransferManage from "pages/WMSManagement/Transfer/TransferManage";
import DocumentManage from "pages/WMSManagement/Documents/DocumentManage";
import AddDocument from "pages/WMSManagement/Documents/AddDocument";
...
const authProtectedRoutes: Array<RouteObject> = [
  ...
  //Warehouse
  { path: "/apps-wms-location", component: LocationManage},
  { path: "/apps-wms-create-location", component: AddLocations },
  { path: "/apps-wms-pallet", component: PalletManage},
  { path: "/apps-wms-create-pallet", component: AddPallet },
  { path: "/apps-wms-plan", component: PlanManage},
  { path: "/apps-wms-create-plan", component: AddPlan },
  { path: "/apps-wms-stock", component: StocksManage},
  { path: "/apps-wms-create-stock", component: AddStocks },
  { path: "/apps-wms-storage-location", component: StorageLocationManage},
  { path: "/apps-wms-create-storage-location", component: AddStorageLocation},
  { path: "/apps-wms-storage-location", component: StorageLocationManage},
  { path: "/apps-wms-create-storage-location", component: AddStorageLocation},
  // AddTransfer
  { path: "/apps-wms-create-transfer", component: AddTransfer },
  { path: "/apps-wms-transfer", component: TransferManage },
  //Document
  { path: "/apps-document", component: DocumentManage },
  { path: "/apps-document-create-type", component: AddDocument },
