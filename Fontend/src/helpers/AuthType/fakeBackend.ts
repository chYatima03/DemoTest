...
import {
  ...
  DocumentsData,
  PlanManageWMSData,
  LocationManageWMSData,
  InboundWMSData,
  InboundDetailWMSData,
  TransferWMSData,
  TransferDetailWMSData,
  StorageLocationWmsData
} from "Common/data";
...
const fakeBackend = () => {
  ...
  //Document Manage
  mock.onGet(url.GET_DOC_LIST).reply(() => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        if (DocumentsData) {
          console.log('mock');
          // Passing fake JSON data as response
          resolve([200, DocumentsData]);
        } else {
          reject([400, "cannot get data"]);
        }
      });
  ...
  //Plan Manage
  mock.onGet(url.GET_PLAN).reply(() => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        if (PlanManageWMSData) {
          console.log('mock');
          // Passing fake JSON data as response
          resolve([200, PlanManageWMSData]);
        } else {
          reject([400, "cannot get data"]);
        }
      });
  ...
  mock.onGet(url.GET_LOCATION).reply(() => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        if (LocationManageWMSData) {
          console.log('mock');
          // Passing fake JSON data as response
          resolve([200, LocationManageWMSData]);
        } else {
          reject([400, "cannot get data"]);
        }
      });
  ...
  //Inbound Manage
  mock.onGet(url.GET_INBOUND).reply(() => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        if (InboundWMSData) {
          console.log('mock');
          // Passing fake JSON data as response
          resolve([200, InboundWMSData]);
        } else {
          reject([400, "cannot get data"]);
        }
      });
  ...
  //Transfer Manage
  mock.onGet(url.GET_TRANSFER).reply(() => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        if (TransferWMSData) {
          console.log('mock');
          // Passing fake JSON data as response
          resolve([200, TransferWMSData]);
        } else {
          reject([400, "cannot get data"]);
        }
      });
  ...
  mock.onGet(url.GET_STORAGELOCATION).reply(() => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        if (StorageLocationWmsData) {
          console.log('mock');
          // Passing fake JSON data as response
          resolve([200, StorageLocationWmsData]);
        } else {
          reject([400, "cannot get data"]);
        }
      });
