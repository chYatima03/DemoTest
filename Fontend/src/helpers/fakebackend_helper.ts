...
//WMS Management
export const getDocument = () => api.get(url.GET_DOC_LIST, null);
export const getPlan = () => api.get(url.GET_PLAN, null);
export const getStoragelocation = () => api.get(url.GET_STORAGELOCATION, null);
export const getLocation = () => api.get(url.GET_LOCATION, null);
export const getTransfer = () => api.get(url.GET_TRANSFER, null);
export const getInbound = () => api.get(url.GET_INBOUND, null);
