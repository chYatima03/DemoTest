...
const WMSManagementSlice = createSlice({
    name: 'WMSManagement',
    initialState,
    reducers: {},
    extraReducers: (builder) => {
        // Employee
        builder.addCase(getPlan.fulfilled, (state: any, action: any) => {
            // console.log(action)
            state.planlist = action.payload;
        });
        builder.addCase(getPlan.rejected, (state: any, action: any) => {
...
export default WMSManagementSlice.reducer;