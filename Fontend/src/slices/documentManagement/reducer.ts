...
const DOCManagementSlice = createSlice({
    name: 'DOCManagment',
    initialState,
    reducers: {},
    extraReducers: (builder) => {
        // Employee
        builder.addCase(getDocuments.fulfilled, (state: any, action: any) => {
            // console.log(action)
            state.documentlist = action.payload;
        });
        builder.addCase(getDocuments.rejected, (state: any, action: any) => {
...
export default DOCManagementSlice.reducer;