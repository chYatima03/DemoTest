...
const widgetsData: WidgetData[] = [
    {
        id: 1,
        icon: <Rocket className="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1" />,
        price: 1452,
        name: "SENT",
    ...
    {
        id: 2,
        icon: <MousePointerClick className="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1" />,
        price: 92.74,
        name: "Open Rate",
    ...
    {
        id: 3,
        icon: <MousePointerSquare className="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1" />,
        price: 3.79,
        name: "CLICKS RATE",
    ...
    {
        id: 4,
        icon: <Goal className="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1" />,
        price: 4.06,
        name: "Click Through",
