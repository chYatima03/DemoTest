                ...
                <div className="flex justify-between p-4 border-b border-slate-200 dark:border-zink-500">
                    ...
                    <div className="shrink-0">
                        <Drawer.Header data-drawer-close="customizerButton" className="transition-all duration-150 ease-linear text-slate-500 hover:text-slate-800 dark:text-zink-200 dark:hover:text-zink-50">
                            <X className="w-4 h-4"></X></Drawer.Header>
                    </div>
                </div>
                    ...
                    {layoutType === "vertical" && <div className="mt-6" id="sidebar-color">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <button
                                ...
                                type="button" id="sidebarColorOne" name="sidebarColor" className={`flex items-center justify-center w-10 h-10 bg-white border rounded-md border-slate-200 group ${layoutSidebarColorType === LEFT_SIDEBAR_COLOR_TYPES.LIGHT ? "active" : ""}`}><Check className="w-5 h-5 hidden group-[.active]:inline-block text-slate-600" /></button>
                            <button
                                value={LEFT_SIDEBAR_COLOR_TYPES.DARK}
                                onClick={() => {
                                    dispatch(changeLeftSidebarColorType(LEFT_SIDEBAR_COLOR_TYPES.DARK));
                                }}
                                type="button" id="sidebarColorTwo" name="sidebarColor" className={`flex items-center justify-center w-10 h-10 border rounded-md border-zink-900 bg-zink-900 group ${layoutSidebarColorType === LEFT_SIDEBAR_COLOR_TYPES.DARK ? "active" : ""}`}><Check className="w-5 h-5 hidden group-[.active]:inline-block text-white" /></button>
                            <button
                                value={LEFT_SIDEBAR_COLOR_TYPES.BRAND}
                                onClick={() => {
                                    dispatch(changeLeftSidebarColorType(LEFT_SIDEBAR_COLOR_TYPES.BRAND));
                                }}
                                type="button" id="sidebarColorThree" name="sidebarColor" className={`flex items-center justify-center w-10 h-10 border rounded-md border-custom-800 bg-custom-800 group ${layoutSidebarColorType === LEFT_SIDEBAR_COLOR_TYPES.BRAND ? "active" : ""}`}><Check className="w-5 h-5 hidden group-[.active]:inline-block text-white" /></button>
                            <button
                                value={LEFT_SIDEBAR_COLOR_TYPES.MODERN}
                                onClick={() => {
                                    dispatch(changeLeftSidebarColorType(LEFT_SIDEBAR_COLOR_TYPES.MODERN));
                                }}
                                type="button" id="sidebarColorFour" name="sidebarColor" className={`flex items-center justify-center w-10 h-10 border rounded-md border-purple-950 bg-gradient-to-t from-red-400 to-purple-500 group ${layoutSidebarColorType === LEFT_SIDEBAR_COLOR_TYPES.MODERN ? "active" : ""}`}><Check className="w-5 h-5 hidden group-[.active]:inline-block text-white" /></button>
                        </div>
                    </div>}
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <button
                                ...
                                type="button" id="topbarColorOne" name="topbarColor" className={`flex items-center justify-center w-10 h-10 bg-white border rounded-md border-slate-200 group ${layoutTopbarColorType === LAYOUT_TOPBAR_THEME_TYPES.LIGHT ? "active" : ""}`}><Check className="w-5 h-5 hidden group-[.active]:inline-block text-slate-600" /></button>
                            <button
                                value={LAYOUT_TOPBAR_THEME_TYPES.DARK}
                                onClick={() => {
                                    dispatch(changeLayoutTopbarColor(LAYOUT_TOPBAR_THEME_TYPES.DARK));
                                }}
                                type="button" id="topbarColorTwo" name="topbarColor" className={`flex items-center justify-center w-10 h-10 border rounded-md border-zink-900 bg-zink-900 group ${layoutTopbarColorType === LAYOUT_TOPBAR_THEME_TYPES.DARK ? "active" : ""}`}><Check className="w-5 h-5 hidden group-[.active]:inline-block text-white" /></button>
                            <button
                                value={LAYOUT_TOPBAR_THEME_TYPES.BRAND}
                                onClick={() => {
                                    dispatch(changeLayoutTopbarColor(LAYOUT_TOPBAR_THEME_TYPES.BRAND));
                                }}
                                type="button" id="topbarColorThree" name="topbarColor" className={`flex items-center justify-center w-10 h-10 border rounded-md border-custom-800 bg-custom-800 group ${layoutTopbarColorType === LAYOUT_TOPBAR_THEME_TYPES.BRAND ? "active" : ""}`}><Check className="w-5 h-5 hidden group-[.active]:inline-block text-white" /></button>
                        </div>
                    </div>
