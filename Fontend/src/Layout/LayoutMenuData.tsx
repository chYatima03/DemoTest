    ...
    },
    {
        ...
        subItems: [
            ...
            },
            {
                ...
                subItems: [
                    ...
                    },
                    {
                        id: 'addstock',
                        label: 'Add Stock',
                        link: '/apps-wms-create-location',
                        parentId: 'stockmanagement'
                    },
                    // {
                    //     id: 'holdstock',
                    //     label: 'Hold Stock',
                    //     link: '/apps-wms-hold-stock',
                    //     parentId: 'stockmanagement'
                    // },
                ],
            },
            ...
            },
            {
                id: 'transfer',
                label: 'Transfer',
                link: '/apps-wms-transfer',
                parentId: 'wmsmanagement'
            },
            {
                id: 'queue',
                label: 'Queue Transfer',
                link: '/apps-wms-queue-transfer',
                parentId: 'wmsmanagement'
            },
            {
                id: 'locationmanage',
                label: 'Location Manage',
                parentId: 'locationmanagement',
                subItems: [
                    {
                        id: 'locaationlist',
                        label: 'Location List',
                        link: '/apps-wms-location',
                        parentId: 'locationmanagement'
                    },
                    {
                        id: 'planlist',
                        label: 'Plan List',
                        link: '/apps-wms-plan',
                        parentId: 'planmanagement'
                    },
                    {
                        id: 'storagelocationlist',
                        label: 'Storage List',
                        link: '/apps-wms-storage-location',
                        parentId: 'storagemanagement'
                    },
                    // {
                    //     id: 'palletlist',
                    //     label: 'Pallet List',
                    //     link: '/apps-wms-pallet',
                    //     parentId: 'palletmanagement'
                    // },
                    {
                        id: 'addlocation',
                        label: 'Add Location',
                    ...
                    },
                    {
                        id: 'addplan',
                        label: 'Add Plan',
                        link: '/apps-wms-create-plan',
                        parentId: 'planmanagement'
                    },
                    {
                        id: 'addstorage',
                        label: 'Add Storage',
                        link: '/apps-wms-create-storage-location',
                        parentId: 'storagemanagement'
                    },
                    // {
                    //     id: 'addpallet',
                    //     label: 'Add Pallet',
                    //     link: '/apps-wms-create-pallet',
                    //     parentId: 'palletmanagement'
                    // },
                ],
            },
